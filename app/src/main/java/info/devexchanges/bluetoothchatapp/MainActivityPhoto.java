...
//    private ArrayList<String> chatMessages;
    ...
    private ChatControllerPhoto chatController;
    ...
    private void findViewsByIds() {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myBitmap.compress(Bitmap.CompressFormat.PNG, 0 /* Ignored for PNGs */, blob);
                byte[] bitmapdata = blob.toByteArray();
                sendPic(blob);
//                sendMessage(bitmapdata);

            }
        });
    }

    private void sendPic(ByteArrayOutputStream blob) {
        chatController.write(blob);
    }
        ...
        switch (requestCode) {
            case REQUEST_ENABLE_BLUETOOTH:
                if (resultCode == Activity.RESULT_OK) {
                    chatController = new ChatControllerPhoto(this, handler);
                } else {
